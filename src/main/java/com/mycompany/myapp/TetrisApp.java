...
public class TetrisApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TetrisApp.class);

    private final Environment env;

    public TetrisApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TetrisApp.class);
